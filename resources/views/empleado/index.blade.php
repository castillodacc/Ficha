            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="/empleado/{{$empleado->id}}/historial" data-toggle="tooltip" data-placement="left" title="Historial">
                      <span class="glyphicon glyphicon-eye-open"></span>
                    </a>
                    <a href="/empleado/{{$empleado->id}}/edit" data-toggle="tooltip" data-placement="left" title="Editar">
                      <span class="glyphicon glyphicon-pencil"></span>
                    </a>
                    {!! Form::open(['url' => '/empleado/'.$empleado->id, 'method' => 'delete', 'style' => 'display: inline-block;']) !!}
                    ...
                    {!! Form::open(['url' => '/empleado/'.$empleado->id.'/disable', 'method' => 'post', 'style' => 'display: inline-block;']) !!}
                    <a class="bloquear" href="#" data-toggle="tooltip" data-placement="right" title="Bloquear">
                      <span class="glyphicon glyphicon-ban-circle"></span>
                    </a>
                    {!! Form::close() !!}
                    @else
                    {!! Form::open(['url' => '/empleado/'.$empleado->id.'/enable', 'method' => 'post', 'style' => 'display: inline-block;']) !!}
